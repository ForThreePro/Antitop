...
let handler = async (m, { conn, command, participants }) => {
    ...
    if (!mentionedJid) return m.reply(`╭─🎀 *『 𝐀𝐍𝐓𝐈𝐓𝐎𝐏 𝐁𝐎𝐓 』* 🎀
│ 💖 *ERROR DE SISTEMA*
│
...
╰─────────────────❒`);
    ...
    if (isUserAdmin) return m.reply(`╭─🎀 *『 𝐀𝐍𝐓𝐈𝐓𝐎𝐏 𝐁𝐎𝐓 』* 🎀
│ 🛡️ *ACCESO DENEGADO*
│
...
╰─────────────────❒`);
    ...
    if (mentionedJid === conn.user.jid) return m.reply(`╭─🎀 *『 𝐀𝐍𝐓𝐈𝐓𝐎𝐏 𝐁𝐎𝐓 』* 🎀
│ 🌸 *PROTOCOLO FALLIDO*
│
