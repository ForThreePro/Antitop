...
let handler = async (m, { conn, groupMetadata }) => {
  ...
  if (participantes.length < 4) {
    return m.reply('❤️‍🩹 *Antitop Bot* ❤️‍🩹\n\nUff... necesito mínimo 4 almas en el grupo para armar 2 parejitas 💔➡️💞')
  }
  ...
  // Armar el mensaje
  let texto = `❤️‍🩹 *ANTITOP BOT - LABORATORIO DEL AMOR* ❤️‍🩹\n\n`
  texto += `✧ El destino acaba de mezclar las cartas... ✧\n\n`
  ...
  texto += `🌙 Que salga amor... o mínimo un buen chisme 🌙\n`
  texto += `✨ Diseñado con cicatrices y glitter por *Antitop Bot* ✨`
